...
According to my result, non-GDS mode (x=1 or x=2) was fine. I am always wonder which DMA engine (GPU's DMA engine or NVMe's DMA engine) play the role of DMA between GPU mem and NVMe mem.
```
